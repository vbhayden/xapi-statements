...
var matchesClientOption_1 = require("../utils/mongoModels/matchesClientOption");
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        query = __assign({ 'statement.id': id }, matchesClientOption_1.default(client, true), (voided === undefined ? {} : { voided: voided }));
