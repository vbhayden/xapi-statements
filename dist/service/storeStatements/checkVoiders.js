...
var getVoiders = function (statements) {
    return statements.reduce(function (result, model) {
        if (isVoiding(model) && model.statement.object.objectType === 'StatementRef') {
            return {
                voiderIds: result.voiderIds.concat([model.statement.id]),
                voidedObjectIds: result.voidedObjectIds.concat([model.statement.object.id]),
                voidingModels: result.voidingModels.concat([model]),
            };
        }
        return result;
