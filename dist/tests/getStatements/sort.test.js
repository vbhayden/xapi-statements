...
describe('get statements by sorting', function () {
    ...
    var sortStatements = function (opts) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    assert(lodash_1.isArray(sortedStatements));
                    assert.equal(sortedStatements.length, 2);
                    return [2 /*return*/, sortedStatements];
            }
        });
    }); };
    it('should return statements in the correct order when ascending', function () { return __awaiter(_this, void 0, void 0, function () {
        var statements;
        return __generator(this, function (_a) {
            switch (_a.label) {
