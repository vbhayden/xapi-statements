...
describe('get statements by slicing', function () {
    ...
    var getStatements = function (opts) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var sliceStatements = function (opts) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    assert(lodash_1.isArray(slicedStatements));
                    return [2 /*return*/, slicedStatements];
            }
        });
    }); };
    it('should return statements when they are inside the limit', function () { return __awaiter(_this, void 0, void 0, function () {
        var statements;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should return statements when they are not sliced', function () { return __awaiter(_this, void 0, void 0, function () {
        var statements;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, sliceStatements({
