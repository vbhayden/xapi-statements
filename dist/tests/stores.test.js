...
describe('insert across 2 different stores with the same id', function () {
    ...
    it('should return the correct statements when calling getStatements', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    it('should return the correct statement when calling getStatements', function () { return __awaiter(_this, void 0, void 0, function () {
        var LRS2_STATEMENT_INSERT, LRS1_STATEMENT, LRS2_STATEMENT;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
