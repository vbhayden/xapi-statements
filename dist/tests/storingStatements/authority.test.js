...
describe('store statement authority', function () {
    ...
    it('should use the authority option when authority is set', function () { return __awaiter(_this, void 0, void 0, function () {
        var statement;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should use the authority option when authority is not set', function () { return __awaiter(_this, void 0, void 0, function () {
        var statement;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, storeStatements([
