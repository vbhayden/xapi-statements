...
describe('store statement stored', function () {
    ...
    it('should generate a stored timestamp when stored is set', function () { return __awaiter(_this, void 0, void 0, function () {
        var statement;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should generate a stored timestamp when stored is not set', function () { return __awaiter(_this, void 0, void 0, function () {
        var statement;
        return __generator(this, function (_a) {
            switch (_a.label) {
