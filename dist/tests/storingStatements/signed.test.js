...
var createSignatureAttachment_1 = require("../utils/createSignatureAttachment");
var createAttachmentModel_1 = require("../utils/createAttachmentModel");
var createAttachmentStatement_1 = require("../utils/createAttachmentStatement");
...
var STATEMENT = __assign({}, BASE_STATEMENT, { id: '33cff416-e331-4c9d-969e-5373a1756120' });
...
describe('store statements with signed attachments', function () {
    ...
    it('should store the signed attachment when it is valid', function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    it('should store the signed attachment when it is valid with other attachments', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    testStatement = __assign({}, STATEMENT, { attachments: [jwsAttachment, otherAttachment] });
    ...
    it('should store the signed attachment when the signed statement misses id', function () { return __awaiter(_this, void 0, void 0, function () {
        var attachmentModel, attachment, testStatement;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    testStatement = __assign({}, BASE_STATEMENT, { attachments: [attachment] });
                    return [4 /*yield*/, storeStatements([testStatement], [attachmentModel])];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
    ...
    it('should throw an error when the signed statement is different', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    attachmentModel = createAttachmentModel_1.default(VALID_JWS);
                    attachment = createSignatureAttachment_1.default(VALID_JWS);
                    testStatement = __assign({}, STATEMENT, { attachments: [attachment], verb: {
    ...
    it('should throw an error when the signed attachment has an empty x5c', function () { return __awaiter(_this, void 0, void 0, function () {
        var attachmentModel, attachment, testStatement, promise;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('should throw an error when the signed attachment has invalid json', function () { return __awaiter(_this, void 0, void 0, function () {
        var attachmentModel, attachment, testStatement, promise;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    it('should throw an error when the signed attachment has an invalid algorithm', function () { return __awaiter(_this, void 0, void 0, function () {
        var attachmentModel, attachment, testStatement, promise;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
