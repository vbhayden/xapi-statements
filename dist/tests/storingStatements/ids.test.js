...
describe('store statement ids', function () {
    ...
    it('should use existing id when they have an id', function () { return __awaiter(_this, void 0, void 0, function () {
        var ids;
    ...
    it('should generate an id when they have no id', function () { return __awaiter(_this, void 0, void 0, function () {
        var ids;
        return __generator(this, function (_a) {
            switch (_a.label) {
