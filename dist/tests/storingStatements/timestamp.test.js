...
describe('store statement timestamp', function () {
    ...
    it('should use existing timestamp when timestamp is set', function () { return __awaiter(_this, void 0, void 0, function () {
        var statement;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should generate a timestamp when timestamp is not set', function () { return __awaiter(_this, void 0, void 0, function () {
        var statement;
        return __generator(this, function (_a) {
            switch (_a.label) {
